...
var MyBestBrands = function MyBestBrands(odl, data, config) {
  ...
  if (data.page.type === 'checkout-confirmation') {
    // collect products
    var products = data.order.products.map(function (p) {
      return {
        pid: p.ean,
        prn: p.name,
        pri: p.priceData.net,
    ...
    en = function en(v) {
      ...
      if (document.images) {
        ...
        document.write('<img src="' + s + '" height="1" width="1" border="0" alt="">');
      }
    };var pr = 'http' + (document.location.protocol == 'https:' ? 's' : '') + ':';
    fr = function fr(s) {
      var d = document;var i = d.createElement("iframe");i.src = s;i.frameBorder = 0;i.width = 0;i.height = 0;i.vspace = 0;i.hspace = 0;i.marginWidth = 0;i.marginHeight = 0;i.scrolling = "no";i.allowTransparency = true;try {
        d.body.insertBefore(i, d.body.firstChild);
      } catch (e) {
        d.write('<ifr' + 'ame' + ' src="' + s + '" width="0" height="0" frameborder="0" vspace="0" hspace="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="true"></ifr' + 'ame>');
      }
    };ap = function ap(o) {
      var v = 'tst=' + ts();if (o.trcCat) {
        v += '&trc=' + en(o.trcCat);
      }
      v += '&ctg=' + en(o.convTarget);var i = o.convId ? o.convId : o.convTarget + ':' + ts();v += '&cid=' + en(i);if (o.ordValue) {
        v += '&orv=' + en(o.ordValue);
      }if (o.ordCurr) {
        v += '&orc=' + en(o.ordCurr);
      }if (o.discValue) {
        v += '&dsv=' + en(o.discValue);
      }if (o.discCode) {
        v += '&dsc=' + en(o.discCode);
      }
      if (o.invValue) {
        ...
        var n = o.isCustNew.toLowerCase();v += '&csn=';v += n == "true" || n == "false" ? n : "null";
      }if (o.custId) {
        v += '&csi=' + en(o.custId);
      }if (o.custGend) {
        var g = o.custGend.toLowerCase();v += '&csg=';
        v += g == "m" || g == "f" ? g : "null";
      }if (o.custAge) {
        v += '&csa=' + en(o.custAge);
      }if (o.basket) {
    ...
    itsStartConv = function itsStartConv(o) {
      var s = pr + '#' + o.trcDomain + '/ts/' + o.advId + '/tsa?typ=f&' + ap(o);fr(s);
    };itsStartConv(itsConv);
    writeScript = function writeScript(s, c) {
      if (typeof c === "undefined") {
        c = "";
      }var d = document;try {
        var a = document.createElement("script");a.type = "text/javascript";a.async = true;a.src = s;if (c != "") {
          a.onload = c;a.onreadystatechange = function () {
